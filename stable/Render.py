...
from ButtonRender import ButtonRender
...
from DelayNotification import DelayNotification
...
class Render():
	def __init__(self, core):
		...
		self.buttonRender = ButtonRender(self.core)
		self.displayFlags = 0
		self.surfaceFlags = 0
		self.renderQueue = {}
		self.status = 0
	...
	def notify(self, text = "Sample notify text", x = 200, y = 200, r = 255, g = 255, b = 255, a = 255, br = 0, bg = 0, bb = 0, ba = 0, font = "assets/arial.ttf", font_size=32, delay=5000):
		self.notifications.append(DelayNotification(self.core, x, y, text, (r, g, b, a), (br, bg, bb, ba), font, font_size, delay))

	def getButtonManager(self):
		return self.buttonRender
	...
	def Initialize(self):
		Log.print("Initializing Display & Surface..")
		self.status = 1
		pygame.init()
		mixer.init()
